...
<div className="bg-[#1F1F1F]"  id="Projetos">
    <div className=" h-screen lg:flex md:flex sm:text-center justify-center items-center ">
      <div className="mx-10 ">
    ...
    <div className="sm:text-center sm:items-center sm:justify-center">
        <h1 className="text-white lg:text-6xl md:text-4xl sm:text-3xl font-bold p-4">Search Game</h1>
